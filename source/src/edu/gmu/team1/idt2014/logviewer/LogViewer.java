...
//						"b/nb", "i", "o");
	...
	/* TODO:
	 * 		 1. Add expressions for class, method, branches, input, and output.
	 * 		 2. Add green/red background for pass/fail.
	 * 		 3. Add Upper/lowercase filtering fix on logviewer.
	 * 		 4. Add clear button for the log
	 * 		 5. Clean up.
	 */
...
//					System.out.println("Status: " + pass + "\n");
				...
				if((date + time + pass + cls + method + branches + input + output).equals(""))
					continue;
				model.addData(date, time, pass, cls, method, branches, input, output);
				date = time = pass = cls = method = branches = input = output = line = "";
			}
